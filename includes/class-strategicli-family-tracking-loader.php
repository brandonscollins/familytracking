 ...
 *
 * A class that is responsible for registering all actions and filters with WordPress.
 *
 ...
 * The loader class.
 *
 * This class is responsible for maintaining and registering all hooks that power
 * the plugin.
 *
 * @since      1.0.0
 * @package    Strategicli_Family_Tracking
 ...
 */
class Strategicli_Family_Tracking_Loader {
